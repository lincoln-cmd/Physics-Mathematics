...
button1.pack()
button2 = Button(window, text = 'Rotational and periodic motion')#, command = rotation)
button2.pack()
button3 = Button(window, text = 'Fluid mechanics')#, command = fluid)
button3.pack()
button4 = Button(window, text = 'Waves')#, command = waves)
button4.pack()
button5 = Button(window, text = 'Thermodynamics')#, command = ther)
button5.pack()
button6 = Button(window, text = 'Electromagnetism')#, command = elec)
button6.pack()
button7 = Button(window, text = 'Optics')#, command = optics)
button7.pack
button8 = Button(window, text = 'Relativity theory')#, command = relativity)
button8.pack()
button9 = Button(window, text = 'Quantum mechanics')#, command = quantum)
button9.pack()
button10 = Button(window, text = 'Nuclear physics')#, command = nuclear)
button10.pack()
button11 = Button(window, text = 'Atmospheric thermodynamics')#, command = atmos-ther)
button11.pack()
button12 = Button(window, text = 'Astrophysics')#, command = astrophysics)
button12.pack()
button13 = Button(window, text = 'DIY experiments')#, command = diy)
button13.pack()
button14 = Button(window, text = 'Rocket mechanics', command = rocket)
button14.pack()
button15 = Button(window, text = 'Calculation')#, command = calculation)
button15.pack()
'''
'''main menu'''
...
def rocket():
    ...
    menu_1.add_command(label = 'Momentum', command = momentum)
...
button1 = Button(window, text = 'Classical mechanics', height = 2, relief = 'groove')#, command = classic)
button1.pack(fill = 'x')
button2 = Button(window, text = 'Rotational and periodic motion', height = 2, relief = 'groove')#, command = rotation)
button2.pack(fill = 'x')
button3 = Button(window, text = 'Fluid mechanics', height = 2, relief = 'groove')#, command = fluid)
button3.pack(fill = 'x')
button4 = Button(window, text = 'Waves', height = 2, relief = 'groove')#, command = waves)
button4.pack(fill = 'x')
button5 = Button(window, text = 'Thermodynamics', height = 2, relief = 'groove')#, command = ther)
button5.pack(fill = 'x')
button6 = Button(window, text = 'Electromagnetism', height = 2, relief = 'groove')#, command = elec)
button6.pack(fill = 'x')
button7 = Button(window, text = 'Optics', height = 2, relief = 'groove')#, command = optics)
button7.pack(fill = 'x')
button8 = Button(window, text = 'Relativity theory', height = 2, relief = 'groove')#, command = relativity)
button8.pack(fill = 'x')
button9 = Button(window, text = 'Quantum mechanics', height = 2, relief = 'groove')#, command = quantum)
button9.pack(fill = 'x')
button10 = Button(window, text = 'Nuclear physics', height = 2, relief = 'groove')#, command = nuclear)
button10.pack(fill = 'x')
button11 = Button(window, text = 'Atmospheric thermodynamics', height = 2, relief = 'groove')#, command = atmos-ther)
button11.pack(fill = 'x')
button12 = Button(window, text = 'Astrophysics', height = 2, relief = 'groove')#, command = astrophysics)
button12.pack(fill = 'x')
button13 = Button(window, text = 'experiments', height = 2, relief = 'groove')#, command = exp)
button13.pack(fill = 'x')
button14 = Button(window, text = 'Rocket mechanics',  height = 2, command = rocket, relief = 'groove')
button14.pack(fill = 'x')


button15 = Button(window, text = 'Calculation', height = 2, relief = 'groove')#, command = calculation)
button15.pack(fill = 'x')

button = Button(window, text = 'Quit', height = 2, relief = 'groove', overrelief = 'solid', fg = 'red', command = quit)
